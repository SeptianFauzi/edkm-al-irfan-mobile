...
const MenuBeriZakatFitrah = ({ route, navigation }) => {
    ...
    return (
        <Tab.Navigator initialRouteName="Peserta">
            <Tab.Screen name="Sisa" children={() => <SisaZakatFitrahSent year_hijriah={year_hijriah} />} />
            <Tab.Screen name="Scan Peserta" children={() => <ScanBeriZakatFitrah year_hijriah={year_hijriah} navigation={navigation} />} />
            <Tab.Screen name="Selesai" children={() => <SelesaiZakatFitrahSent year_hijriah={year_hijriah} />} />
        </Tab.Navigator>
    )
}
