    ...
    if (state.loadingSelesaiSent || !state.qurbanSelesaiSent) {
        ...
        return (
            <View style={styles.container}>
                ...
                <FlatList data={state.qurbanSelesaiSent} style={{ width: '90%', maxHeight: '80%', marginBottom: '2%' }}
                ...
                <View style={{ flexDirection: 'row', width: '80%', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Button style={{ marginHorizontal: '2%' }} icon="refresh" onPress={() => dispatch(GetStatusSelesaiQurbanSent({ year_hijriah: year_hijriah, location: location }))} loading={state.loadingData} disabled={state.loadingData} mode="outlined">Reload</Button>
                </View>
                {/* </View> */}
            </View >
        )
        ...
        return (
            <View style={styles.container}>
                <View style={styles.sub_container}>
                    ...
                    <Title style={{ textAlign: 'center' }}>Semua Peserta Belum Diberikan Qurbannya</Title>
