...
const TerimaZakatFitrah = ({ route, navigation }) => {

    const [yearHijriah, setyearHijriah] = useState(moment().iYear())

    const onSubmit = (data) => {
        navigation.navigate('MenuTerimaZakatFitrah', {
        ...
        <View style={styles.container}>
            <View style={styles.sub_container}>
                ...
                <Controller
                    ...
                    name="year_hijriah"
                />
                {errors.year_hijriah?.message ? <Caption style={{ color: 'red', alignItems: 'flex-start' }}>{errors.year_hijriah?.message}</Caption> : <View></View>}
...
export default TerimaZakatFitrah
