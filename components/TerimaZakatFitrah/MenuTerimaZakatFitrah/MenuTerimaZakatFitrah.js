...
const MenuTerimaZakatFitrah = ({ route, navigation }) => {
    ...
    return (
        <Tab.Navigator initialRouteName="Peserta">
            <Tab.Screen name="Sisa" children={() => <SisaZakatFitrahReceived year_hijriah={year_hijriah} />} />
            <Tab.Screen name="Scan Peserta" children={() => <ScanTerimaZakatFitrah year_hijriah={year_hijriah} navigation={navigation} />} />
            <Tab.Screen name="Selesai" children={() => <SelesaiZakatFitrahReceived year_hijriah={year_hijriah} />} />
        </Tab.Navigator>
    )
}
