...
const MenuTerimaCelengan = ({ route, navigation }) => {
    ...
    return (
        <Tab.Navigator initialRouteName="Peserta">
            <Tab.Screen name="Sisa" children={() => <SisaMoneyReceived year_hijriah={year_hijriah} />} />
            <Tab.Screen name="Scan Peserta" children={() => <ScanTerimaCelengan year_hijriah={year_hijriah} navigation={navigation} />} />
            <Tab.Screen name="Selesai" children={() => <SelesaiMoneyReceived year_hijriah={year_hijriah} />} />
        </Tab.Navigator>
    )
}
