...
const ScanTerimaCelengan = ({ route, navigation, year_hijriah }) => {
        ...
        <View style={styles.container}>
            <View style={styles.sub_container}>
                <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginVertical: '5%' }}>
                    ...
                    <Button onPress={() => navigation.navigate('QrCodeKumpulZakatFitrah', { type: 'TerimaCelengan', year_hijriah: year_hijriah })} style={{ width: '100%', color: '#fff' }} loading={loading} disabled={loading} mode="contained"><Text style={{ color: 'white' }}>Scan</Text></Button>
                </View>
            </View>
        </View >
    )
...
export default ScanTerimaCelengan
